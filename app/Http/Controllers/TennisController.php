...
class TennisController extends Controller
{
    ...
    public function addSpace(Request $request)
    {
        ...
        return redirect('/space/tennis/overview')->with('success', '球場新增成功！');
    ...
    public function editSpaceShow($spaceId)
    {
        ...
        return view('tennis/edit', compact('court')); // Pass the court data to the view
    }
    

    public function editSpace(Request $request, $spaceId)
    {
        Log::info('editSpace 網球執行');
        Log::info('接收到的數據', $request->all());
        ...
        return redirect('/space/tennis/overview')->with('success', '球場更新成功！');
    }
    ...
    public function deleteSpace($spaceId)
    {
        try {
            ...
            return redirect('/space/tennis/overview')->with('success', '球場刪除成功！');
        } catch (\Exception $e) {
    ...
    public function overviewSpace(){
        ...
        $basketballCourts = Court::with('ballType')->where('type', 3)->get();
        ...
        return view('tennis/overview', compact('courts'));
