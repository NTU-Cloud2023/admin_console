...
class VolleyballController extends Controller
{
    ...
    public function addSpace(Request $request)
    {
        ...
        return redirect('/space/volleyball/overview')->with('success', '球場新增成功！');
    ...
    public function editSpaceShow($spaceId)
    {
        ...
        return view('volleyball/edit', compact('court')); // Pass the court data to the view
    }
    

    public function editSpace(Request $request, $spaceId)
    {
        Log::info('editSpace 排球執行');
        Log::info('接收到的數據', $request->all());
        ...
        return redirect('/space/volleyball/overview')->with('success', '球場更新成功！');
    }
    ...
    public function deleteSpace($spaceId)
    {
        try {
            ...
            return redirect('/space/volleyball/overview')->with('success', '球場刪除成功！');
        } catch (\Exception $e) {
    ...
    public function overviewSpace(){
        ...
        // Get all courts of type basketball
        $basketballCourts = Court::with('ballType')->where('type', 2)->get();

        // For each basketball court, get the CourtCurrent record associated with it
        ...
        return view('volleyball/overview', compact('courts'));
