                            ...
                            <div class="page-header-content pt-4">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        ...
                                        <div class="page-header-subtitle">可以在這邊管理你的球種</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        @foreach ($ball_types as $ball_type)
                                        <tr>
                                            <td>{{ $ball_type->type }}</td>
                                            <td>{{ $ball_type->game_name }}</td>
                                            <td>{{ $ball_type->cht_game_name }}</td>
                                            <td>Coming soon
                                                <!-- <button class="btn btn-datatable btn-icon btn-transparent-dark me-2"><i data-feather="tool"></i></button> -->
